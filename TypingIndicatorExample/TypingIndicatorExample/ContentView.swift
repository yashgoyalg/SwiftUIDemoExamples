...
//
//  Created by iOS-dev on 30/05/24.
//
...
//                    .padding(20)
                   // if showSpinner {
                        Circle()
                            ...
                            .stroke(LinearGradient(colors: [.green,.brown], startPoint: .topLeading, endPoint: .bottomTrailing),style: StrokeStyle(lineWidth: 8.0,lineCap: .round,lineJoin:.round))
